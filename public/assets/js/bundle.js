...
var Cadastro = /*#__PURE__*/function () {
  function Cadastro(fromClass) {
  ...
  _createClass(Cadastro, [{
    ...
    value: function events() {
      var _this = this;
      this.form[5].addEventListener('click', function (e) {
        e.preventDefault();
        var cepValue = _this.form[4].value;
        pesquisaCep(cepValue);
        function pesquisaCep(_x) {
          return _pesquisaCep.apply(this, arguments);
        }
        function _pesquisaCep() {
          _pesquisaCep = _asyncToGenerator( /*#__PURE__*/_regeneratorRuntime().mark(function _callee(cepValue) {
            var response, jsonData;
            return _regeneratorRuntime().wrap(function _callee$(_context) {
              while (1) switch (_context.prev = _context.next) {
                case 0:
                  _context.next = 2;
                  return fetch("https://cdn.apicep.com/file/apicep/".concat(cepValue, ".json"));
                case 2:
      ...
      function setLocal(local) {
        var localValue = document.querySelector(".local");
...
/* harmony import */ var _modules_Cadastro__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(/*! ./modules/Cadastro */ "./frontend/modules/Cadastro.js");
...
var cadastro = new _modules_Cadastro__WEBPACK_IMPORTED_MODULE_2__["default"]('.form-cadastro');
//login.init()
cadastro.init();
})();
