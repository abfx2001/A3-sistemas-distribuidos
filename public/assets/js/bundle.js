...
var login = new (_modules_login__WEBPACK_IMPORTED_MODULE_2___default())('.form-login');
var cadastro = new (_modules_login__WEBPACK_IMPORTED_MODULE_2___default())('.form-cadastro');
login.init();
cadastro.init();
})();
